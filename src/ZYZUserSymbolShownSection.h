...
#ifndef __ZY_LIB_ZHUYIN_USER_SYMBOL_SHOWN_SECTION_H_
#define __ZY_LIB_ZHUYIN_USER_SYMBOL_SHOWN_SECTION_H_
...
class UserSymbolShownSection: public SymbolSection {
    typedef std::vector<String>::iterator iterator_t;

public:
    UserSymbolShownSection (PhoneticEditor & editor,
                            ZhuyinProperties & props);
    virtual ~UserSymbolShownSection ();
